 ...
 * @Description:
 */
export const CHANGE_BANNER = "MHRecommend/CHANGE_BANNER";
export const CHANGE_HOT_RECOMMEND = "MHRecommend/CHANGE_HOT_RECOMMEND";
export const CHANGE_NEW_ALBUM = "MHRecommend/CHANGE_NEW_ALBUM";
